...
class Cliente extends db {
    ...
    public function  getCamposTabelaFormatado(){
        $aCTabela = $this->GetInfoFieldsTable(tb_cliente);        
        $sCampos = null;
    ...
    public function getCliente($id = null, $campos = array()) {
        if (empty($id)) {
            return erro_id;
        }
        ...
        if ($campos == null) {
            ...
            $sql = "select $lista_campos from " . tb_cliente . " where id = $id";
            ...
            $query = $this->fetch("select $lista_campos from " . tb_cliente . " where id = $id");
            return $query;
        }
    }

    public function getClienteMascara($id = null, $campos = array()) {
        $mask = new Util;
        if (empty($id)) {
            return erro_id;
        }
        $temp = $this->getCliente($id);
        $saida = array();
    ...
    public function getClientes($campos = array(), $filtro = array()) {
        if (empty($campos)) {
            $lista_campos = '*';
        } else {
            $lista_campos = '';
        ...
        $sql = "select $lista_campos from " . tb_cliente . " $filtros";
    ...
    public function fields_tb_clientes() {
        ...
        return $this->FieldsTable(tb_cliente);
    }
